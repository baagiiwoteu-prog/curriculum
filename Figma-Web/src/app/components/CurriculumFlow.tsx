  ...
  return (
    <div className="w-full h-full bg-white overflow-auto">
      <div className="min-w-[1400px] min-h-[1300px] p-12">
        ...
        {/* Legend */}
        <div className="mt-12 ml-16 max-w-xl">
          <div className="text-xs font-bold text-gray-900 mb-3">Legend</div>
          <div className="space-y-2 text-xs text-gray-700 font-medium">
            <div className="flex items-center gap-3">
              <div className="w-8 h-2 bg-gray-600 opacity-75 rounded-full"></div>
              <span>Solid flow = direct continuation</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-2 bg-gray-600 opacity-75 rounded-full" style={{ clipPath: 'polygon(0 40%, 40% 0, 100% 0, 100% 60%, 60% 100%, 0 100%)' }}></div>
              <span>Split flow = subject differentiation</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-2 border-t-2 border-dashed border-gray-600 opacity-60"></div>
              <span>Lighter / dashed flow = partial or indirect continuity</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 border-[2.5px] border-gray-600 rounded bg-white"></div>
              <span>No incoming flow = subject introduced later</span>
            </div>
          </div>
          
          {/* Color domains */}
          <div className="mt-6 text-xs font-bold text-gray-900 mb-3">
            Domain Colors
          </div>
          <div className="grid grid-cols-2 gap-x-6 gap-y-2 text-xs text-gray-700 font-medium">
            <div className="flex items-center gap-2">
              <div
                className="w-4 h-4 rounded"
                style={{ backgroundColor: "#2563ab" }}
              ></div>
            ...
            <div className="flex items-center gap-2">
              <div
                className="w-4 h-4 rounded"
                style={{ backgroundColor: "#7b5d99" }}
              ></div>
              <span>Society & life orientation</span>
            </div>
            <div className="flex items-center gap-2">
              <div
                className="w-4 h-4 rounded"
                style={{ backgroundColor: "#a6555a" }}
              ></div>
              <span>Arts, music & design</span>
            </div>
            <div className="flex items-center gap-2">
              <div
                className="w-4 h-4 rounded"
                style={{ backgroundColor: "#2d7d8b" }}
              ></div>
